# The standing coder block

The owner's text. Paste this block **verbatim** at the top of every brief to anything that writes
code, before any task-specific instruction. Do not paraphrase it, shorten it or merge it with your
own rules: a paraphrase is how a rule loses its teeth.
...
Task-specific rules (which files, which mutation proves the test, "do not delegate") go **after**
