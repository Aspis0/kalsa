 ...
 *
 * Payload fields, in assignment order: op, ok, keepModel, budgetBytes,
 * policy, forced?, freeBytes, sidecars, victims, bytes, victimModels,
 * totalBytes, poolBytes, reason?, errorType?.
 *
