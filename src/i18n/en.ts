...
export const en = {
  ...
  drawer: {
    ...
    exportAction: "Export",
    deleteAction: "Delete",
    exportConversationA11y: "Export conversation {title}",
    deleteConversationA11y: "Delete conversation {title}",
  ...
  settings: {
    ...
    themeDark: "Dark",
    webToggle: "Web",
    webWhenAsked: "Search the web when you ask",
    ...
    contextSizeHint:
      "How many tokens the assistant keeps at once. A longer context costs more memory; a size this phone cannot hold is disabled. Takes effect on the next model load.",
    contextSizeAuto: "Device default — choose a size to override it.",
    contextSizeOption: "{tokens} tokens",
    contextSizeResolved: "Resolved: {tokens} tokens",
...
Manual "Report a problem" is under your control: do not paste sensitive content — that text goes to a public GitHub form if you submit it.`,
  ...
  chat: {
    ...
    exportYou: "**You**",
    exportAi: "**AI**",
    historyGuardTitle: "Can't save new messages in this chat",
    historyGuardBody:
      "This conversation's stored history is unreadable and couldn't be set aside safely. To protect it, new messages won't be saved here until you start a new chat. The existing history is left untouched on this device.",
    ...
    historyUnreadableTitle: "This chat's history couldn't be read",
