...
#   unit-testable (scripts/device/test_sideload_guards.sh).
#
...
# Covered by scripts/device/test_sideload_guards.sh.
...
# silently ran on CPU. Covered by scripts/device/test_sideload_guards.sh.
validate_bench_ngl() {
  case "${1:-}" in
    "") return 0 ;;
