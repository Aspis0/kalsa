 ...
 *
 *   node scripts/bench/quality/bpb.mjs [--only <substr>] [--langs en,it,es,fr]
 */
...
const matrix = JSON.parse(readFileSync(path.join(ROOT, "scripts/bench/quality/matrix.json"), "utf8"));
