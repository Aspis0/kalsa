 ...
 * - readMemoryTelemetry from scripts/bench/benchGrade.mjs
 * - collectMemoryTelemetryByMode, collectMemoryExtractTelemetryByMode, and
 *   findEmptyStoreFailures from scripts/bench/benchAggregate.mjs
 */
...
function test8_sessionInitCapturePathSurfacesMode() {
  ...
  const ciBench = readFileSync(path.join(projectRoot, "scripts/ci/ci-bench.sh"), "utf8");
  assert(
